...
export default function Content() {
  ...
  return (
    <>
      ...
      <div className="information">
        <p className="para11">
          هل تبحث عن افضل شركة لشراء أثاث مستعمل بشمال وجنوب الرياض بتقييم
          العملاء؟
        </p>
        <p className="para22">
          يوجد لدينا محلات بسوق حراج لشراء الاثاث المستعمل بالرياض ، ومتخصصون في
          شراء الاثاث المستعمل منذ سنوات من كل العملاء بجميع احياء الرياض ، وهنا
        </p>
        <p className="para22">
          شراء الأثاث المستعمل ، ودفع فرق بسيط وهنا توفير للوقت والجهد وتقوم
          بنقل العفش من والى منزلك ، سواء كان الاثاث القديم او الأثاث الجديد
          وتقوم{" "}
        </p>
        <p className="para22">
          بالاختيار المناسب لك ونسعد بخدمتك و مع تحيات افضل شركة شراء اثاث
          مستعمل بالرياض .
        </p>
      </div>
      <br />
